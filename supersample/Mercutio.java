...
public class Mercutio extends AdvancedRobot {
	 ...
	 */
	ArrayList<Mercutio.MovementWave> moveWaves=new ArrayList<Mercutio.MovementWave>();
	ArrayList<Mercutio.GunWave> gunWaves=new ArrayList<Mercutio.GunWave>();
